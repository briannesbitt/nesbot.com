...
<script src="<?=$urlJs?>shBrushPlain.js" type="text/javascript"></script>
<script src="<?=$urlJs?>shBrushScala.js" type="text/javascript"></script>
<script src="<?=$urlJs?>shBrushJScript.js" type="text/javascript"></script>
<script src="<?=$urlJs?>shBrushPhp.js" type="text/javascript"></script>
